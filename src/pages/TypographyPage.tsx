...
const TypographyPage: React.FC = () => {
    const typographyVariants = [
        ...
        },
        {
            ...
            sampleText:
                'Body Large - これは本文テキストの例です。読みやすさを重視したサイズと行間で設計されています。',
        },
        {
            ...
            sampleText:
                'Body Medium - これは説明文やキャプションに使用される中程度のサイズのテキストです。',
        },
        {
            ...
            sampleText:
                'Body Small - 補足情報や注釈に使用される小さなテキストです。',
        },
        {
        ...
        },
        {
            ...
            name: 'Display Large',
            description:
                '最も大きな見出し。ランディングページやヒーローセクションに使用',
    ...
    return (
        <Box sx={{ p: 4 }}>
            ...
            <Typography variant='body1' paragraph>
                Material Design
                3のタイポグラフィスケールは、読みやすさとヒエラルキーを重視して設計されています。
                    ...
                    {colorVariants.map((colorInfo) => (
                        <Box key={colorInfo.name}>
                            ...
                            <Typography variant='body1' color={colorInfo.color}>
                                これは{colorInfo.description}
                                を使用した本文テキストの例です。 Material Design
                                3では、適切なコントラスト比を保ちながら、
                                美しいタイポグラフィを実現しています。
                            </Typography>
                        </Box>
                    ))}
            ...
            <Paper elevation={1} sx={{ p: 4, mb: 4 }}>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                    ...
                    <Typography variant='body2' paragraph>
                        ...
                        最も重要な情報（ページタイトル、ヒーロー見出し）
                    </Typography>
                    <Typography variant='body2' paragraph>
                        • <strong>Headline:</strong>{' '}
                        セクションの見出し（記事タイトル、カードヘッダー）
                    </Typography>
                    <Typography variant='body2' paragraph>
                        • <strong>Title:</strong>{' '}
                        小さなコンポーネントのタイトル（ツールバー、タブ）
                    </Typography>
                    <Typography variant='body2' paragraph>
                        • <strong>Body:</strong>{' '}
                        本文テキスト（記事内容、説明文）
            ...
            <Paper elevation={1} sx={{ p: 4 }}>
                ...
                <Typography variant='body1' paragraph>
                    これは記事の本文の例です。Material Design
                    3のタイポグラフィシステムを使用することで、
